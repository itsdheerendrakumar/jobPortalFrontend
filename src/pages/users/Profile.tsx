        ...
        <div>
            <div className="flex justify-center items-center flex-col gap-2.5">
                <Avatar className="h-24 w-24">
                    <AvatarImage src={preview || "https://github.com/shadcn.png"} alt="@shadcn" />
                    <AvatarFallback><User size={16}/></AvatarFallback>
                </Avatar>
                <Button size="lg" className="bg-chart-2 hover:bg-chart-2/85 cursor-pointer min-w-24" disabled={profileMutation.isPending} onClick={onUpload}>
